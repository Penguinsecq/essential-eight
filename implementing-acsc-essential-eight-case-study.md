...
4. Monitor Event Logs for a while, depends on your environment, but I would suggest more than 4 weeks. You may need to keep an eye on longer if your business has application will be running monthly or quarterly or yearly.
...
| |
|---|
| ![AppLocker Implmentation diagram](https://github.com/Penguinsecq/penguinsecq.github.io/raw/main/docs/images/applocker-implement-diagram.png) |
